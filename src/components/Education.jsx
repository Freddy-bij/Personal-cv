...
const Education = () => {
  return (
    <div>
         <div className='bg-white ml-10 mr-10 pt-7 '>
      <div className=' pb-8 border-b-2 border-gray-500'>
      <div className='bg-gray-950 w-1/4  text-white flex  rounded-full justify-center py-1 hover:bg-white hover:shadow-md hover:text-gray-950'><FaGraduationCap/><h1 className='uppercase text-2xl font-bold '>education</h1></div> 
